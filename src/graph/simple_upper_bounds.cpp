...
bool calculate_simple_upper_bounds(rflcs_graph::graph &graph) {
    auto is_improving = set_simple_upper_bounds(graph.matches);
    is_improving |= set_simple_upper_bounds(graph.reverse_matches);
